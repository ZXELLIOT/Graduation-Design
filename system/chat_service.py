    ...
    def _safe_trace(trace_meta: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            "context": {
                ...
                "overlap_ratio": float(context_meta.get("overlap_ratio", 0.0)),
                "semantic_ratio": float(context_meta.get("semantic_ratio", 0.0)),
                "semantic_checked": bool(context_meta.get("semantic_checked", False)),
                "context_score": float(context_meta.get("context_score", 0.0)),
